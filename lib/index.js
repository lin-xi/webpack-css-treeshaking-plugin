...
var CSSTreeShakePlugin = function () {
  function CSSTreeShakePlugin(options) {
    _classCallCheck(this, CSSTreeShakePlugin);

    this.options = Object.assign({}, { remove: true, showInfo: true }, options);
  }

  _createClass(CSSTreeShakePlugin, [{
    key: 'apply',
  ...
  return CSSTreeShakePlugin;
}();

exports.default = CSSTreeShakePlugin;